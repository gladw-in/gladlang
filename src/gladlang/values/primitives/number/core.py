"""Core Number with slots, construction, and generic protocol methods."""

from gladlang.core.errors import RuntimeError
from gladlang.values.value import Value


class NumberCore(Value):
    ...
    def copy(self):
        ...
        number_copy = Number(self.value)
        number_copy.set_position(self.position_start, self.position_end)
        number_copy.set_context(self.context)
        return number_copy
